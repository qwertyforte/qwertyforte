...
│       ├── agent_engine.js                # Slash command parser (/libre, /freeform, reserved multilingual /help, /checkmark, tickets)
│       ├── ticket_store.js                # State snapshot manager with timeline history, source attribution, delta logging & rollback
